<#
.SYNOPSIS
  Install the 1-on-1 tutor skill for Claude Code by linking
    ~/.claude/skills/1-on-1-tutor-mode  ->  <this repo>/skills/1-on-1-tutor-mode
...
$src = Join-Path $here "skills\1-on-1-tutor-mode"
$dest = Join-Path $SkillsDir "1-on-1-tutor-mode"
...
Write-Output "In any project, run: /1-on-1-tutor-mode <topic or path to materials>"
